...
namespace FrigidBlackwaters.Game
{
    public class ResistBox : DamageReceiverBox<ResistBox, BreakBox, BreakInfo>
    {
        ...
        protected override BreakInfo ProcessDamage(BreakBox breakBox, Vector2 position, Vector2 direction)
        {
            BreakInfo breakInfo = new BreakInfo(breakBox.OffensiveResistance, this.defensiveResistance.ImmutableValue);
