...
{
    public abstract class DamageDealerBoxAnimatorToolPropertyDrawer<DB, RB, I> : ColliderAnimatorToolPropertyDrawer where DB : DamageDealerBox<DB, RB, I> where RB : DamageReceiverBox<RB, DB, I> 
    {
